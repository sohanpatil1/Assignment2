...
class connect4():
	...
	def gameOver(self, j, player):	#Used to check whether current state has a winner or has tied. J is column number
	...
	def getBoard(self):	#Returns the board as a 2d array as board[row][col]
